...
// Generado el: 2021.04.22 a las 08:59:57 PM CDT 
//
...
public class BuscarVentaResponse {
    ...
    protected List<BuscarVentaResponse.Elemento> elemento;
     ...
     * {@link BuscarVentaResponse.Elemento }
     * 
     * 
     */
    public List<BuscarVentaResponse.Elemento> getElemento() {
        if (elemento == null) {
            elemento = new ArrayList<BuscarVentaResponse.Elemento>();
        }
